<?php $__env->startSection('content'); ?>
                                ...
                                <div class="px_info_box">
                                    ...
                                    <div class="px_info">
                                        ...
                                        <a class="px_margin0 px_font14"
                                            href="tel:+91<?php echo e(preg_replace('/\D/', '', $siteNumber->value)); ?>">+ (91)
                            ...
                            <div class="col-xl-6 col-lg-12 col-md-6 col-sm-6 col-xs-12">
                                <div class="px_info_box">
                                    ...
                                    <div class="px_info">
                                        <h5>Mail Us</h5>
                                        <a class="px_margin0 px_font14"
                                            href="mailto:<?php echo e($siteEmail->value); ?>"><?php echo e($siteEmail->value); ?></a>
    ...
    <div class="px_map_section">
        <iframe src="<?php echo e($map_url); ?>" width="600" height="450" style="border:0;" allowfullscreen=""
