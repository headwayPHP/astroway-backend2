        ...
        <div class="block xl:grid grid-cols-2 gap-4">
            <div class="hidden xl:flex flex-col min-h-screen">
                ...
                <div class="my-auto">
                    ...
                    ?>
                    <img alt="AstroGuru image" class="-intro-x w-1/2 -mt-16" src="<?php echo e(env('APP_URL') . '/' . $logo->value); ?>"
            ...
            <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                <div
                    ...
                    <img alt="AstroGuru image" class="-intro-x w-1/2 -mt-16 xl:hidden"
                        src="<?php echo e(env('APP_URL') . '/' . $logo->value); ?>" style="height: 140px;width: 140px;margin:auto">
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\astroway-backend2\resources\views/pages/login.blade.php ENDPATH**/ ?>