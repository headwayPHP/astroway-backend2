                                ...
                                <div>
                                    <div class="input">
                                        <div>
                                            ...
                                            <textarea onkeypress="return validateJavascript(event);" id="features" required class="form-control" name="features"
                                                placeholder="Features" minlength="10" required><?php echo e($product['features']); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="input">
                                        <div>
                                            ...
                                            <img id="thumb" width="150px" src="<?php echo e($product['productImage']); ?>"
                                                alt="Product image" onerror="this.style.display='none'"; />
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\astroway-backend2\resources\views/pages/edit-product.blade.php ENDPATH**/ ?>