                    ...
                    <div class="box">
                        <div class="p-5">
                            <div
                                ...
                                <img alt="Banner image" class="rounded-md" src="<?php echo e(asset($banner->bannerImage)); ?>">
                            </div>
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\astroway-backend2\resources\views/pages/banner-list.blade.php ENDPATH**/ ?>