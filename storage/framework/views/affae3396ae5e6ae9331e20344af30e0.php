                ...
                <div class="d-flex align-items-center w-50">
                    ...
                    <a class="navbar-brand" href="<?php echo e(route('front.home')); ?>">
                        <div class="d-flex align-items-center">
                            <img src="<?php echo e(env('APP_URL') . '/' . $logo->value); ?>" alt="<?php echo e($appName->value); ?>"
                                class="img-fluid" width="53" height="53">
                            <div class="astroway-logo-ntext ml-2">
                                <span class="astroway-logo-text"><?php echo e($appName->value); ?></span>
                                <span class="astroway-logo-subtext">Solve your problems, Achieve your goals</span>
                            </div>
                        </div>
                    </a>
                                    ...
                                    <div class="dropdown-menu user-options fadeInUp5px dropdown-menu-right dropdown-menu-lg-left"
                                        ...
                                        <ul>
                                            <li class="namedisplay d-block text-center">
                                                ...
                                                <div>
                                                    <h2 class="pt-3">
                                                        <?php echo e(str_repeat('X', 6) . substr(authcheck()['contactNo'], -4)); ?>
                                            ...
                                            <li class="d-block">
                                                <div>
                                                    <a class="dropdown-item"
                                                        href="<?php echo e(route('front.getMyFollowing')); ?>">
                                                        <span class="mr-2">
            ...
            fetch("<?php echo e(route('api.getUserNotification', ['token' => $token])); ?>", {
                ...
                .then(data => {
                    ...
                    data.recordList.forEach(notification => {
                        ...
                        if (notification.id > lastchild && lastchild != undefined && (isChatAccepted ||
                                isCallAccepted))
                ...
                `;
                        ...
                        if ((isChatAccepted || isCallAccepted) && !processedNotifications.has(
                                notification.id)) {
                            ...
                            if (isChatAccepted) {
                                ...
                                setCallIds(notification.callId, notification.astrologerId, notification
                                    .call_type);
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\astroway-backend2\resources\views/frontend/layout/header.blade.php ENDPATH**/ ?>