<?php $__env->startSection('content'); ?>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                    ...
                    <a href="<?php echo e(route('front.aboutus')); ?>" class="px_link" style="background-color:var(--primary-color); color:#fff; padding:0.5em 1em; border-radius: 0.25em; margin-top: 2em; transfrom:translateY(10px);">read
                            more</a>
                </div>
    ...
    <?php echo $__env->make('layout.components.banner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div class="container">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                                <div class="px_blog_box">
                                    ...
                                    <h4 class="px_subheading"><a
                                            href="blog_left_detail.html"> <?php echo e(\Illuminate\Support\Str::limit(strip_tags($video->videoTitle), 29)); ?></a>
                                    </h4>
        ...
        <div class="text-center mt-5" >
            <a href="<?php echo e(route('front.videos')); ?>" class="btn" style="background: var(--primary-color); color: var(--secondary-color); font-weight:bold; scale:1.1;">See more</a>
        </div>
    </section>
