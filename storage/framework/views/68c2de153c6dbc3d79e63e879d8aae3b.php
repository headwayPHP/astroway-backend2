    ...
    <div class="grid grid-cols-11 gap-x-6 mt-5 pb-20">
        <div class="intro-y col-span-12 2xl:col-span-12">
            <div class="intro-y box">
                ...
                <form method="POST" enctype="multipart/form-data" id="edit-profile" action="<?php echo e(route('editProfileApi')); ?>">
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\astroway-backend2\resources\views/pages/edit-profile.blade.php ENDPATH**/ ?>