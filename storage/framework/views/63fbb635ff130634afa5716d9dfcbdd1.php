                    ...
                    <div id="<?php echo e($group->flagGroupName); ?>"
                                ...
                                <?php if($systemFlag->valueType == 'MultiSelectWebLang'): ?>
                                    ...
                                    <div>
                                        ...
                                        <select
                                            ...
                                            <?php $__currentLoopData = $language; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($lan->languageCode); ?>"
                                                    <?php echo e(in_array($lan->languageCode, $selectedLanguages) ? 'selected' : ''); ?>>
                        ...
                        <?php if(count($group->subGroup) > 0): ?>
                            <?php $__currentLoopData = $group->subGroup; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subGroupIndex => $subGroup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <h4
                                    class="my-4 text-lg font-medium <?php echo e(strtolower(str_replace(' ', '_', $subGroup->flagGroupName))); ?>">
                                ...
                                <?php if($subGroup->parentFlagGroupId == 2): ?>
                                    <div class="mb-2">
                                        <input type="hidden" value="<?php echo e($subGroup->id); ?>"
                                            name="flaggroups[<?php echo e($subGroup->id); ?>][id]">
                                        <label>
                                            <input class="form-check-input" type="radio"
                                                name="flaggroups[<?php echo e($subGroup->id); ?>][isActive]" value="1"
                                                <?php echo e($subGroup->isActive ? 'checked' : ''); ?>>
                                            Enable
                                        </label>
                                        <label>
                                            <input class="form-check-input" type="radio"
                                                name="flaggroups[<?php echo e($subGroup->id); ?>][isActive]" value="0"
                                                <?php echo e(!$subGroup->isActive ? 'checked' : ''); ?>>
                                            Disable
                                        </label>
                                    </div>
                                ...
                                <div class="box p-3 <?php echo e(strtolower(str_replace(' ', '_', $subGroup->flagGroupName))); ?>">
                                    <?php if($subGroup->flagGroupName == 'AstrologyAPI'): ?>
                                        <select name="astroApiCallType" id="astroApiCallType">
                                            ...
                                            <option value="3" <?php echo e($astroApiCallType == 3 ? 'selected' : ''); ?>>Vedic
                                                Astro API</option>
                                        </select>
                                    <?php endif; ?>
                                                ...
                                                <?php if($groupIndex == 3): ?>
                                                    <div class="flex flex-col sm:flex-row mt-2">
                                                        <div class="form-check mr-2">
                                                            ...
                                                            <label class="form-check-label" for="radio-switch-4">Google
                                                                Bucket</label>
                                                        </div>
                                                        <div class="form-check mr-2 mt-2 sm:mt-0">
                                                            <input class="form-check-input bucket_radio" type="radio"
                                                            ...
                                                            <label class="form-check-label" for="radio-switch-5">AWS
                                                                Bucket</label>
                                                        </div>
                                                    </div>
                                                <?php else: ?>
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\astroway-backend2\resources\views/pages/system-flag.blade.php ENDPATH**/ ?>