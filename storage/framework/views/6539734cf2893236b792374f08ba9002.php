            ...
            <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0">
                <form action="<?php echo e(route('products')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="w-56 relative text-slate-500" style="display:inline-block">
                        <input onkeypress="return validateJavascript(event);" value="<?php echo e($searchString); ?>" type="text"
                            class="form-control w-56 box pr-10" placeholder="Search..." id="searchString"
                            name="searchString">
                        <?php if(!$searchString): ?>
                        ...
                        <div class="p-5">
                            <div
                                ...
                                <img alt="Product image" class="rounded-t-md" src="<?php echo e($product['productImage']); ?>"
                                    onerror="this.onerror=null;this.src="<?php echo e(asset('images/product.png')); ?>";" />
                            ...
                            <div class="text-slate-600 dark:text-slate-500 mt-5">
                                <div class="flex items-center">
                                    <i data-lucide="link" class="w-4 h-4 mr-2"></i> Amount:
                                    <?php echo e($currency->value); ?><?php echo e($product['amount']); ?>
                                ...
                                <div class="sm:grid grid-cols gap-2">
                                    ...
                                    <div class="input">
                                        <div>
                                            ...
                                            <textarea onkeypress="return validateJavascript(event);" type="text" name="answer" id="answer"
                                                class="form-control" placeholder="Answer" required></textarea>
                                        </div>
                                    </div>
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\astroway-backend2\resources\views/pages/product.blade.php ENDPATH**/ ?>