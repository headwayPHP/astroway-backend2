                                    ...
                                    <div class="input">
                                        <div>
                                            ...
                                            <input onkeypress="return validateJavascript(event);" type="text"
                                                name="channel" id="channel" class="form-control" placeholder="Channel"
                                                required>
                                        </div>
                                    </div>
                                    <div class="input">
                                        <div>
                                            ...
                                            <input onkeypress="return validateJavascript(event);" type="text"
                                                name="link" id="link" class="form-control" placeholder="Link"
                                                required>
                                        </div>
                                    </div>
                                    <div class="input">
                                ...
                                <div class="sm:grid grid-cols gap-2">
                                    <div class="input">
                                        <div>
                                            ...
                                            <label for="youtubeLink" class="form-label">Channel</label>
                                            <input onkeypress="return validateJavascript(event);" type="text"
                                                name="channel" id="echannel" class="form-control" placeholder="Channel"
                                                required>
                                        </div>
                                    </div>
                                    <div class="input">
                                        <div>
                                            <label for="youtubeLink" class="form-label">Link</label>
                                            <input onkeypress="return validateJavascript(event);" type="text"
                                                name="link" id="elink" class="form-control" placeholder="Link"
                                                required>
                                        </div>
                                    </div>
                                    <div class="input">
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\astroway-backend2\resources\views/pages/news.blade.php ENDPATH**/ ?>