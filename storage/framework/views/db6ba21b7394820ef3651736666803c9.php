...
<?php $__env->startSection('subcontent'); ?>
    ...
    <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#add-money"
        class="btn btn-primary shadow-md mr-2 mt-10 d-inline addbtn rechargewallet">Recharge Wallet</a>
                                ...
                                <div class="sm:grid grid-cols gap-2  ">
                                    <div class="input">
                                        <div>
                                            ...
                                            <select data-placeholder="Select users" class="form-control select2"
                                                ...
                                                <?php $__currentLoopData = $userdatas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $userdata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($userdata->userId); ?>" required>
                                                        <?php echo e($userdata->userName); ?> -
                                                        <?php echo e($userdata->usercontactNo ? $userdata->usercontactNo : $userdata->email); ?>
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\astroway-backend2\resources\views/pages/customer-list.blade.php ENDPATH**/ ?>