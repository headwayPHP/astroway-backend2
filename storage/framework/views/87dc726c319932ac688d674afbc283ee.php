                                ...
                                <td class="text-center">
                                    <div class="flex justify-center items-center">
                                        ...
                                        <a class="flex items-center mr-3 text-success"
                                            href="<?php echo e(url('public/' . $req->pdf_link)); ?>" target="_blank">
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\astroway-backend2\resources\views/pages/kundali-earnings.blade.php ENDPATH**/ ?>