                            ...
                            <?php $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                                    <div class="px_blog_box">
                                        ...
                                        <h4 class="px_subheading"><a href="<?php echo e($video->youtubeLink); ?>">
                                                <?php echo e(\Illuminate\Support\Str::limit(strip_tags($video->videoTitle), 29)); ?></a>
                                        </h4>
                                    </div>
                                </div>
...
<?php echo $__env->make('v2.frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\astroway-backend2\resources\views/v2/frontend/pages/videos.blade.php ENDPATH**/ ?>