...
<?php $__env->startSection('subcontent'); ?>
    ...
    <a class="btn btn-primary shadow-md mr-2 mt-10 d-inline addbtn" href="<?php echo e(route('testimonialadd')); ?>">Add Testimonial</a>

    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0">
                <form action="<?php echo e(route('testimoniallist')); ?>" method="GET" enctype="multipart/form-data">
                        ...
                        <tr class="intro-x">
                            ...
                            <td>
                                <?php if($testimonial->image): ?>
                                    <img src="<?php echo e(asset('storage/app/public/' . $testimonial->image)); ?>" alt="Image"
                            ...
                            <td>
                                <div
                                    class="flex items-center justify-start <?php echo e($testimonial->status == 'active' ? 'text-success' : 'text-danger'); ?>">
                            ...
                            <td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    <a class="flex items-center mr-3 text-success"
                                        href="<?php echo e(route('testimonialshow', $testimonial->id)); ?>">
                                        <i data-lucide="eye" class="w-4 h-4 mr-1"></i>View
                                    </a>
                                    <a class="flex items-center mr-3"
                                        href="<?php echo e(route('testimonialedit', $testimonial->id)); ?>">
                                        <i data-lucide="check-square" class="w-4 h-4 mr-1"></i>Edit
                                    </a>
                                    <a href="javascript:;" class="flex items-center deletebtn text-danger"
                                        onclick="if(confirm('Are you sure you want to delete this testimonial?')) { document.getElementById('delete-form-<?php echo e($testimonial->id); ?>').submit(); }">
                                        <i data-lucide="trash-2" class="w-4 h-4 mr-1"></i>Delete
                                    </a>

                                    <form id="delete-form-<?php echo e($testimonial->id); ?>"
                                        action="<?php echo e(route('testimonialdelete', $testimonial->id)); ?>" method="POST"
                                        style="display: none;">
                                        <?php echo csrf_field(); ?>
            ...
            <nav class="w-full sm:w-auto sm:mr-auto">
                <ul class="pagination" id="pagination">
                    <li class="page-item <?php echo e($page == 1 ? 'disabled' : ''); ?>">
                        <a class="page-link"
                            href="<?php echo e(route('testimoniallist', ['page' => $page - 1, 'searchString' => $searchString])); ?>">
                    ...
                    <?php if($startPage > 1): ?>
                        <li class="page-item"><a class="page-link"
                                href="<?php echo e(route('testimoniallist', ['page' => 1, 'searchString' => $searchString])); ?>">1</a>
                        </li>
                        <?php if($startPage > 2): ?>
                    ...
                    <?php for($i = $startPage; $i <= $endPage; $i++): ?>
                        <li class="page-item <?php echo e($page == $i ? 'active' : ''); ?>">
                            <a class="page-link"
                                href="<?php echo e(route('testimoniallist', ['page' => $i, 'searchString' => $searchString])); ?>"><?php echo e($i); ?></a>
                        </li>
                    <?php endfor; ?>
                    ...
                    <?php if($endPage < $totalPages): ?>
                        ...
                        <?php endif; ?>
                        <li class="page-item"><a class="page-link"
                                href="<?php echo e(route('testimoniallist', ['page' => $totalPages, 'searchString' => $searchString])); ?>"><?php echo e($totalPages); ?></a>
                        </li>
                    <?php endif; ?>
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\astroway-backend2\resources\views/pages/testimoniallist.blade.php ENDPATH**/ ?>