                            ...
                            <div class="mt-3">
                                <div class="sm:grid grid-cols gap-2">
                                    ...
                                    <div class="input" id="classic-editor">
                                        ...
                                        <textarea onkeypress="return validateJavascript(event);" class="form-control ml-3" id="description" name="description"
                                            required></textarea>
                                    </div>
                                ...
                                <div class="sm:grid grid-cols gap-2">
                                    ...
                                    <div class="input">
                                        <div>
                                            ...
                                            <textarea onkeypress="return validateJavascript(event);" type="text" name="did" id="did"
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\astroway-backend2\resources\views/pages/notification-list.blade.php ENDPATH**/ ?>