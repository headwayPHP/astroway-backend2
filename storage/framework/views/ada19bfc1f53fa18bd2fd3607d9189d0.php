            ...
            <nav class="w-full sm:w-auto sm:mr-auto">
                <ul class="pagination">
                    ...
                    <?php if($endPage < $totalPages): ?>
                        ...
                        <li class="page-item">
                            <a class="page-link"
                                href="<?php echo e(route('story-list', ['page' => $totalPages])); ?>"><?php echo e($totalPages); ?></a>
                        </li>
                    <?php endif; ?>
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\astroway-backend2\resources\views/pages/story-list.blade.php ENDPATH**/ ?>