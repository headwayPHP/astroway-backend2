...
<div class="mobile-menu md:hidden">
    <div class="mobile-menu-bar" style="background-color:#426f7f">
        <a href="" class="flex mr-auto">
            ...
            ?>
            <img alt="Midone - HTML Admin Template" class="w-6" src="<?php echo e(env('APP_URL') . '/' . $logo->value); ?>">
        </a>
...
<!-- END: Mobile Menu -->
<?php /**PATH C:\xampp\htdocs\astroway-backend2\resources\views////layout/components/mobile-menu.blade.php ENDPATH**/ ?>