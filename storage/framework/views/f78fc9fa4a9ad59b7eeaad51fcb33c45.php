                    ...
                    <div class="box">
                        <div class="p-5">
                            <div
                                ...
                                <img alt="Product image" class="rounded-md"
                                    src="<?php echo e(env('APP_URL') . '/' . $productCat['categoryImage']); ?>">
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\astroway-backend2\resources\views/pages/astroMall.blade.php ENDPATH**/ ?>