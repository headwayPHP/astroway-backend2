...
<?php $__env->startSection('subcontent'); ?>
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 box p-5 space-y-4">
            <div><strong>Client Name:</strong> <?php echo e($client->client_name); ?></div>

            <div>
                <strong>Status:</strong>
                <span class="ml-2 <?php echo e($client->status == 'active' ? 'text-success' : 'text-danger'); ?>">
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\astroway-backend2\resources\views/pages/clientshow.blade.php ENDPATH**/ ?>