<?php $__env->startSection('content'); ?>
    ...
    <div class="ds-head-body">
        ...
        <div class="container mt-3">
            ...
            <div class="slider">
                ...
                <button class="bannerbtn bannerbtn-next" aria-label="Next slide"><i
                    ...
                    <ul class="list-unstyled d-flex mb-0 px-lg-4 px-xl-5 mx-xl-5 pt-3 pb-lg-3">
                        ...
                        <li class="today-panchang">
                            <a href="<?php echo e(route('front.getPanchang')); ?>">
                                <div class="text-center mb-2 mb-md-0">
                                    <div class="icon">
                                        <img src="<?php echo e($panchang['value']); ?>" alt="" height="55" width="55">
                                    </div>
                        ...
                        <li class="cheating-and-affairs">
                            <a href="<?php echo e(route('front.getkundali')); ?>">
                                <div class="text-center mb-2 mb-md-0">
                                    <div class="icon">
                                        <img src="<?php echo e($freekundali['value']); ?>" alt="" height="55" width="55">
                                    </div>
        ...
        <div class="container mt-5 <?php echo e(empty($liveastro['recordList']) ? 'mb-5' : ''); ?>">
            ...
            <div class="stories-container">
                <?php $__currentLoopData = $stories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $story): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="story <?php echo e($story->allStoriesViewed > 0 ? 'viewed' : ''); ?>"
                        data-astrologer-id="<?php echo e($story->astrologerId); ?>" data-astrologer-name="<?php echo e($story->name); ?>"
                        data-astrologer-profile="<?php echo e($story->profileImage); ?>">
    ...
    <?php if(isset($home_data['astrologyVideo']) && count($home_data['astrologyVideo']) > 0): ?>
        <div class="astroway-customer-stories bg-red-dark py-4 py-md-5">
            <div class="container">
                <div class="row pb-2">
                    <div class="col-sm-12">
                        <h2 class="text-md-center heading text-black">Latest Videos</h2>
            ...
            <div class="row ">
                <div class="col-sm-12">
                    <h2 class="heading text-center">What Is Astrology?<span class="ml-3" data-toggle="collapse"
                            href="#collapse-faq" role="button" aria-expanded="false" aria-controls="collapse-faq"><i
                                class="fa fa-chevron-down color-red"></i></span></h2>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
                    <div class="collapse py-4 font-14" id="collapse-faq">
                        ...
                        <h3 class="font-weight-bold">Online Astrologers Of Dhaval Zaveri</h3>
    ...
    <div class="astroway-about d-none d-md-block py-4 py-md-5">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <h2 class="text-md-center heading">WHY Dhaval Zaveri?</h2>
                ...
                <div class="col-sm-12">
                    <div class="accordion" id="faq">
                        ...
                        <div class="card">
                            ...
                            <div id="privacy-guaranteed" class="collapse" aria-labelledby="faqhead3" data-parent="#faq">
                                <div class="card-body">
    ...
    <div class="astroway-about-mobile d-md-none bg-pink py-4">
        <div class="container">
            <h2 class="heading text-center">WHY Dhaval Zaveri?</h2>
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\astroway-backend2\resources\views/frontend/pages/index.blade.php ENDPATH**/ ?>