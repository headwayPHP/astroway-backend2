                        ...
                        <tr class="intro-x">
                            ...
                            <td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    ...
                                    <a id="editbtn" href="javascript:;"
                                        onclick="delbtn({{ $team->id }},{{ $team->userId }})"
                                ...
                                <div class="sm:grid grid-cols gap-2 py-4">
                                    <div class="input">
                                        <div>
                                            ...
                                            <input onkeypress="return validateJavascript(event);" type="email"
                                ...
                                <div class="sm:grid grid-cols gap-2 mt-2">
                                    <div class="input">
                                        <div>
                                            ...
                                            <input onkeypress="return validateJavascript(event);" type="password"
                                    ...
                                    <div class="sm:grid grid-cols gap-2 py-4">
                                        <div class="input">
                                            <div>
                                                <label for="email" class="form-label">Email</label>
                                                <input onkeypress="return validateJavascript(event);" type="email"
                                                    name="email" id="aid" class="form-control"
                                                    placeholder="example@gmail.com">
                                                <div class="text-danger print-email-error-msg mb-2" style="display:none">
                                                    <ul></ul>
                                                </div>
                                    ...
                                    <div class="sm:grid grid-cols gap-2">
                                        <div class="input">
                                            <div>
                                                ...
                                                <div class="text-danger print-contactNo-error-msg mb-2"
                                                    style="display:none">
                                                    <ul></ul>
                                                </div>
                                            </div>
                                    ...
                                    <div class="sm:grid grid-cols gap-2 mt-2">
                                        <div class="input">
                                            <div>
                                                <label for="password" class="form-label">Password</label>
                                                <input onkeypress="return validateJavascript(event);" type="password"
                                                    name="password" id="epassword" class="form-control"
