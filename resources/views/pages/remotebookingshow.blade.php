                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        @if ($booking->layout_map)
                            ...
                            @if (in_array($ext, ['jpg', 'jpeg', 'png', 'gif']))
                                <img src="{{ $layoutPath }}" alt="Layout Map"
                                    class="cursor-pointer rounded-md w-40 h-40 object-cover border"
                                    onclick="openModal('{{ $layoutPath }}')">
                            @elseif ($ext === 'pdf')
                                <embed src="{{ $layoutPath }}" type="application/pdf" width="100%" height="300px" />
                            @endif

                            <a href="{{ $layoutPath }}" download
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        @if ($booking->compass_reading)
                            @php $compassPath = asset('storage/app/public/' . $booking->compass_reading); @endphp
                            <img src="{{ $compassPath }}" alt="Compass Reading"
                                class="cursor-pointer rounded-md w-40 h-40 object-cover border"
                                onclick="openModal('{{ $compassPath }}')">

                            <a href="{{ $compassPath }}" download
                                class="inline-flex items-center text-blue-600 hover:text-blue-800 mt-3">
