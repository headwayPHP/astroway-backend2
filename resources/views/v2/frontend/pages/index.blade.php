...
@section('content')
    ...
    <section
        class="px_about_wrapper px_about_wrapper_new px_padderTop80 px_padderBottom80 px-dark-section-new px-bg-none">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                    ...
                    <p>As a Civil Engineer and Vastu expert, Dhaval combines ancient wisdom with modern scientific
                        ...
                        Astrology.</p>
                    <p style="margin-bottom:30px;">Our mission is to spread happiness, wealth, and peace by applying Indian energy dynamics to
                    ...
                    <a href="{{ route('front.aboutus') }}" class="px_link" style="background-color:var(--primary-color); color:#fff; padding:0.5em 1em; border-radius: 0.25em; margin-top: 2em; transfrom:translateY(10px);">read
                            more</a>
                </div>
    ...
    <h1 class="px_heading px_heading_center text-center" style="">our clients</h1>
    <div class="client-marquee">
    ...
    @include('layout.components.banner')
    {{-- @include('layout.components.divider') --}}
    {{-- @include('v2.frontend.components.services') --}}
    @include('v2.frontend.components.services', ['services' => $limitedServices])
    @include('layout.components.divider')
    ...
    <div class="container">
                                ...
                                <div class="px_blog_box">
                                    <div class="px_blog_img" style="height: 300px; overflow: hidden; position: relative;">
                                        <a href="{{ $video->youtubeLink }}" target="_blank">
                                            ...
                                            <div class="play-icon-overlay" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; display: flex; justify-content: center; align-items: center;">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="72" height="72" fill="rgba(255,255,255,0.8)">
                                    ...
                                    <h4 class="px_subheading"><a
                                            href="blog_left_detail.html"> {{ \Illuminate\Support\Str::limit(strip_tags($video->videoTitle), 29) }}</a>
                                    </h4>
        ...
        <div class="text-center mt-5" >
            <a href="{{ route('front.videos') }}" class="btn" style="background: var(--primary-color); color: var(--secondary-color); font-weight:bold; scale:1.1;">See more</a>
        </div>
    </section>
