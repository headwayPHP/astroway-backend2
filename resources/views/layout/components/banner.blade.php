        ...
        <div class="banner-slider" id="bannerSlider">
            <div class="banner-track" id="bannerTrack">
                <div class="banner-slide">
                    <img src="{{ asset('public/images/Frame1437256174.png') }}" alt="Astrology Consultation">
                ...
                <div class="banner-slide">
                    <img src="{{ asset('public/images/Frame1437256175.png') }}" alt="Vastu Consultation">
                    <div class="slide-content">
                ...
                <div class="banner-slide">
                    <img src="{{ asset('public/images/Frame1437256173.png') }}" alt="Personal Consultation">
                    <div class="slide-content">
                ...
                <div class="banner-slide">
                    <img src="{{ asset('public/images/Frame1437256176.png') }}" alt="Spiritual Solutions">
                    <div class="slide-content">
