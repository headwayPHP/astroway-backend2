                                ...
                                @if (authcheck())
                                    @if (!$getfollower)
                                        <form id="followastro" class="ml-5">
                                            <input type="hidden" name="astrologerId"
                                                value="{{ $getAstrologer['recordList'][0]['id'] }}">
                                            <a class="btn btn-lg bg-white rounded text-dark font-weight-bold buttonshowmoreprofile"
                            ...
                            <div class="profile-buttons d-block align-items-center justify-content-center ">
                                @if ($getAstrologer['recordList'][0]['chatStatus'] == 'Busy')
                                    <div class="my-2 position-relative">
                                        <a
                                            class="btn-block  colorblack  btn-chat-profile expert-busy btn-opacity disabled">
                                            <span class="d-flex w-100 justify-content-between">
                                                <span class="position-relative">
                                                    <span class="d-block mb-3 font-weight-bold"> Chat </span>
                                                    <span
                                                        class="d-block font-12 position-absolute bsy-txtded text-left font-16">
                                                        Busy </span>
                                                </span>
                                ...
                                @else
                                    <div class="my-2 position-relative">
                                        <a class="btn-block btn-chat-profile colorblack" data-toggle="modal"
                                            role="button" id="chat-btn"
