                                        ...
                                        <div class="item mb-3" d-flex>
                                            ...
                                            <div class="content p-3 bg-white">
                                                <p class="text-center font-weight-semi font-weight-bold category mb-2"><a
                                                        href=""
                                                        class="colorblack font-weight-bold">{{ $getproductdetails['recordList'][0]['name'] }}</a>
                                                </p>


                                                <div class="text-center pb-1">
                                                    <p><span
                                                            class="color-red">{{ $currency['value'] }}{{ $getproductdetails['recordList'][0]['amount'] }}</span>
                                                    </p>
                                                    @if (!authcheck())
                                                        <a role="button" data-toggle="modal" data-target="#loginSignUp"
                                                            class="btn view-more color-red font-weight-normal mb-2">
                                                            Buy Now
                                                        </a>
                                                    @else
                                                        <a href="{{ route('front.checkout', ['id' => $getproductdetails['recordList'][0]['id']]) }}"
                                                            role="button"
                                                            class="btn view-more color-red font-weight-normal mb-2">
                                                            Buy Now
                                                        </a>
