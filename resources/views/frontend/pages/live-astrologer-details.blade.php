                            ...
                            <div class="position-relative  text-center w-100">
                                ...
                                <div style="box-shadow: inset 0px 0px 3px #ccc !important ">
                                    <h4 class="d-block font-weight-bold  py-2 font-16" id="leave-expert-name">Available
                                        Wallet
                                        Balance <span class="color-red">{{ $currency['value'] }} <span
                                                id="gift-wallet-balance"
                    ...
                    $('#send-gift').click(function(e) {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                var new_wallet_amount = response.wallet_balance
                                    .amount;
                                $('#gift-wallet-balance').text(
                                    new_wallet_amount);
                                toastr.success('Gift Sent Successfully');
                                sendMSG('GIF_MSG::Sent ' + giftName +
                                    ' Gift 🎁');
                            },
