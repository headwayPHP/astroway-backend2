                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                @foreach ($getUserById['recordList'][0]['orders']['order'] as $orderdata)
                                    @if (!empty($orderdata))
                                        <tr>
                                            <td><a class="colorblack btn view-pdf"
                                                    href="{{ $orderdata['invoice_link'] }}"><i
                                                        class="fa-solid fa-file-pdf color-red"></i></a></td>
                                            <td>{{ $orderdata['productName'] }}</td>
                                            <td><img src="{{ $orderdata['productImage'] }}" alt="User" class="img-fluid"
