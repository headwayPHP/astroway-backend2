                ...
                <div class="col-md-12 d-flex align-items-center">
                    ...
                    <span style="text-transform: capitalize; ">
                        <span class="text-white breadcrumbs">
                            ...
                            <i class="fa fa-chevron-right"></i> <span class="breadcrumbtext">Astrologer Profile
                                Update</span>
                        </span>
                    </span>
        ...
        <div class="container py-5">
            ...
            <div class="row pt-3 pb-lg-5">
                    ...
                    <form action="{{ route('front.updateAstrologer') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" id="name"
                                        value="{{ $getAstrologer['recordList']['0']['name'] }}" name="name"
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <input type="email" id="email"
                                        value="{{ $getAstrologer['recordList']['0']['email'] }}" name="email"
                                        class="form-control rounded">
                                </div>
                                <div class="col-6 mb-3">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    @if ($getAstrologer['recordList'][0]['profileImage'])
                                        <div id="imagePreviewContainer" class="mt-2">
                                            <img id="imagePreview"
                                                src="{{ $getAstrologer['recordList'][0]['profileImage'] }}"
                                                alt="Current Profile Image" style="max-width: 100%; max-height: 200px;">
                                            <input type="hidden" id="oldProfileImage" name="oldProfileImage"
                                                value="{{ $getAstrologer['recordList'][0]['profileImage'] ?? '' }}">
                                        </div>
                                    @else
                            ...
                            <div class="row">
                                <div class="col-6 mb-3">
                                    ...
                                    <select class="form-control" name="gender" id="gender">
                                        <option value="Male"
                                            {{ $getAstrologer['recordList'][0]['gender'] === 'Male' ? 'selected' : '' }}>
                                            Male</option>
                                        <option value="Female"
                                            {{ $getAstrologer['recordList'][0]['gender'] === 'Female' ? 'selected' : '' }}>
                                            Female</option>
                                    </select>
                                </div>
                                <div class="col-6 mb-3">
                                    ...
                                    <select class="form-control select2" name="astrologerCategoryId[]"
                                        ...
                                        @foreach ($categories as $category)
                                            <option value="{{ $category['id'] }}"
                                                {{ in_array($category['id'], array_column($getAstrologer['recordList'][0]['astrologerCategoryId'], 'id')) ? 'selected' : '' }}>
                                ...
                                <div class="col-6 mb-3">
                                    <label for="primarySkill">Primary Skills<span
                                            class="color-red font-weight-bold">*</span></label>
                                    <select class="form-control select2" name="primarySkill[]" id="primarySkill"
                                        multiple>
                                        @foreach ($skills as $skill)
                                            <option value="{{ $skill['id'] }}"
                                                {{ in_array($skill['id'], array_column($getAstrologer['recordList'][0]['primarySkill'], 'id')) ? 'selected' : '' }}>
                                                {{ $skill['name'] }}
                                            </option>
                                        @endforeach
                                        <!-- Add more categories as needed -->
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <select class="form-control select2" name="allSkill[]" id="allSkill" multiple>
                                        @foreach ($skills as $skill)
                                            <option value="{{ $skill['id'] }}"
                                                {{ in_array($skill['id'], array_column($getAstrologer['recordList'][0]['allSkill'], 'id')) ? 'selected' : '' }}>
                                                {{ $skill['name'] }}
                                            </option>
                                        @endforeach
                                        <!-- Add more categories as needed -->
                                ...
                                <div class="col-6 mb-3">
                                    <label for="languageKnown">Language<span
                                            class="color-red font-weight-bold">*</span></label>
                                    <select class="form-control select2" name="languageKnown[]" id="languageKnown"
                                        multiple>
                                        @foreach ($languages as $language)
                                            <option value="{{ $language->id }}"
                                                {{ in_array($language->id, array_column($getAstrologer['recordList'][0]['languageKnown'], 'id')) ? 'selected' : '' }}>
                                ...
                                <div class="col-6 mb-3">
                                    <label for="charge">Add your charge(as per min)<span
                                            class="color-red font-weight-bold">*</span></label>
                                    <input type="number" value="{{ $getAstrologer['recordList'][0]['charge'] }}"
                                        id="charge" name="charge" class="form-control rounded">
                                </div>
                                <div class="col-6 mb-3">
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <input type="number"
                                        value="{{ $getAstrologer['recordList'][0]['experienceInYears'] }}"
                                ...
                                <div class="col-6 mb-3">
                                    <label for="dailyContribution">How many hours you can contribute daily?<span
                                            class="color-red font-weight-bold">*</span></label>
                                    <input type="number"
                                        value="{{ $getAstrologer['recordList'][0]['dailyContribution'] }}"
                                ...
                                <div class="col-6 mb-3">
                                    <label for="hearAboutAstroguru">Where did you hear about {{ $appname['value'] }}?<span
                                            class="color-red font-weight-bold">*</span></label>
                                    <input type="text"
                                        value="{{ $getAstrologer['recordList'][0]['hearAboutAstroguru'] }}"
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <input type="radio" id="astro-yes" name="isWorkingOnAnotherPlatform"
                                        value="1"
                                        {{ isset($getAstrologer['recordList'][0]['isWorkingOnAnotherPlatform']) && $getAstrologer['recordList'][0]['isWorkingOnAnotherPlatform'] == '1' ? 'checked' : '' }}>
                                    Yes
                                    <input type="radio" id="astro-no" name="isWorkingOnAnotherPlatform"
                                        value="0"
                                        {{ isset($getAstrologer['recordList'][0]['isWorkingOnAnotherPlatform']) && $getAstrologer['recordList'][0]['isWorkingOnAnotherPlatform'] == '0' ? 'checked' : '' }}>
                                    No
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-6 mb-3">
                                    <label for="whyOnBoard">Why do you think we should onboard you?<span
                                            class="color-red font-weight-bold">*</span></label>
                                    <input type="text" id="awhyOnBoard" name="whyOnBoard"
                                        class="form-control rounded"
                                    ...
                                    <select class="form-control" name="mainSourceOfBusiness" id="mainSourceOfBusiness">
                                        @foreach ($mainSourceBusiness as $source)
                                            <option value="{{ $source->jobName }}"
                                                {{ $getAstrologer['recordList'][0]['mainSourceOfBusiness'] == $source->jobName ? 'selected' : '' }}>
                                                {{ $source->jobName }}
                                            </option>
                                        @endforeach
                                        <!-- Add more categories as needed -->
                                    ...
                                    <select class="form-control" name="highestQualification" id="highestQualification">
                                        @foreach ($highestQualification as $highest)
                                            <option value='{{ $highest->qualificationName }}'
                                                {{ $getAstrologer['recordList'][0]['highestQualification'] == $highest->qualificationName ? 'selected' : '' }}>
                                    ...
                                    <select class="form-control" name="degree" id="degree">
                                        @foreach ($qualifications as $qua)
                                            <option value='{{ $qua->degreeName }}'
                                                {{ $getAstrologer['recordList'][0]['degree'] == $highest->degree ? 'selected' : '' }}>
                                                {{ $qua->degreeName }}
                                            </option>
                                        @endforeach
                                        <!-- Add more categories as needed -->
                                ...
                                <div class="col-6 mb-3">
                                    <label for="college">College/School/University name<span
                                            class="color-red font-weight-bold">*</span></label>
                                    <input type="text" value="{{ $getAstrologer['recordList'][0]['college'] }}"
                                        id="college" name="college" class="form-control rounded">
                                </div>
                                <div class="col-6 mb-3">
                                ...
                                <div class="col-6 mb-3">
                                    <label for="instaProfileLink">Instagram profile link<span
                                            class="color-red font-weight-bold">*</span></label>
                                    <input type="text"
                                        value="{{ $getAstrologer['recordList'][0]['instaProfileLink'] }}"
                                ...
                                <div class="col-6 mb-3">
                                    <label for="facebookProfileLink">Facebook profile link<span
                                            class="color-red font-weight-bold">*</span></label>
                                    <input type="text"
                                        value="{{ $getAstrologer['recordList'][0]['facebookProfileLink'] }}"
                                ...
                                <div class="col-6 mb-3">
                                    <label for="linkedInProfileLink">LinkedIn profile link<span
                                            class="color-red font-weight-bold">*</span></label>
                                    <input type="text"
                                        value="{{ $getAstrologer['recordList'][0]['linkedInProfileLink'] }}"
                                ...
                                <div class="col-6 mb-3">
                                    <label for="youtubeChannelLink">Youtube profile link<span
                                            class="color-red font-weight-bold">*</span></label>
                                    <input type="text"
                                        value="{{ $getAstrologer['recordList'][0]['youtubeChannelLink'] }}"
                                ...
                                <div class="col-6 mb-3">
                                    <label for="websiteProfileLink">Website profile link<span
                                            class="color-red font-weight-bold">*</span></label>
                                    <input type="text"
                                        value="{{ $getAstrologer['recordList'][0]['websiteProfileLink'] }}"
                                        id="websiteProfileLink" name="websiteProfileLink" class="form-control rounded">
                                </div>
                                <div class="col-6 mb-3">
                                    <label>Did anybody referred you?<span
                                            class="color-red font-weight-bold">*</span></label><br>
                                    <input type="radio" id="astro-yes" name="isAnyBodyRefer" value="1"
                                        {{ isset($getAstrologer['recordList'][0]['isAnyBodyRefer']) && $getAstrologer['recordList'][0]['isAnyBodyRefer'] == '1' ? 'checked' : '' }}>
                                    Yes
                                    <input type="radio" id="astro-no" name="isAnyBodyRefer" value="0"
                                        {{ isset($getAstrologer['recordList'][0]['isAnyBodyRefer']) && $getAstrologer['recordList'][0]['isAnyBodyRefer'] == '0' ? 'checked' : '' }}>
                                    No
                                </div>
                        ...
                        <div id="step4"
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 mb-3">
                                    <label for="NoofforeignCountriesTravel">Number of the foreign countries you
                                        lived/travel
                                    ...
                                    <select class="form-control" name="NoofforeignCountriesTravel"
                                        ...
                                        @foreach ($countryTravel as $travel)
                                            <option value="{{ $travel->NoOfCountriesTravell }}"
                                                {{ $getAstrologer['recordList'][0]['NoofforeignCountriesTravel'] == $travel->NoOfCountriesTravell ? 'selected' : '' }}>
                                    ...
                                    <select class="form-control" name="currentlyworkingfulltimejob"
                                        ...
                                        @foreach ($jobs as $working)
                                            <option value="{{ $working->workName }}"
                                                {{ $getAstrologer['recordList'][0]['currentlyworkingfulltimejob'] == $working->workName ? 'selected' : '' }}>
                                                {{ $working->workName }}
                                            </option>
                                        @endforeach
                                        <!-- Add more categories as needed -->
                                ...
                                <div class="col-6 mb-3">
                                    <label for="loginBio">Long Bio<span
                                            class="color-red font-weight-bold">*</span></label>
                                    <textarea id="loginBio" name="loginBio" class="form-control rounded">{{ $getAstrologer['recordList'][0]['loginBio'] }}</textarea>
                                </div>
                                <div class="col-6 mb-3">
                                    <label for="goodQuality">What are some good qualities of perfect astrologer?<span
                                            class="color-red font-weight-bold">*</span></label>
                                    <textarea id="goodQuality" name="goodQuality" class="form-control rounded">{{ $getAstrologer['recordList'][0]['goodQuality'] }}</textarea>
                                </div>
                                <div class="col-6 mb-3">
                                    ...
                                    <textarea id="biggestChallenge" name="biggestChallenge" class="form-control rounded">{{ $getAstrologer['recordList'][0]['biggestChallenge'] }}</textarea>
                                </div>

                                <div class="col-6 mb-3">
                                    <label for="whatwillDo">A customer is asking the same question repeatedly: what will
                                        you
                                        do?<span class="color-red font-weight-bold">*</span></label>
                                    <textarea id="whatwillDo" name="whatwillDo" class="form-control rounded">{{ $getAstrologer['recordList'][0]['whatwillDo'] }}</textarea>
                                </div>
                            </div>
                            <div class="col-12 text-center">
                                <a class="btn btn-chat btn-chat-lg font-weight-bold px-5 py-2"
                ...
                <div class="col-lg-6 sychics-join-info pt-lg-0 pt-5">
                    <h2><small class="font-weight-bold">BECOME "{{ strtoupper($appname['value']) }} VERIFIED"
                            ASTROLOGER</small></h2>
                    <p>
                        {{ $appname['value'] }}, one of the best online astrology portals gives you a chance to be a part
                        of
                        its community
