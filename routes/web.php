...
// use App\Http\Controllers\API\User\ProductDetailController as ProductController;
...
Route::get(
    'color-scheme-switcher/{color_scheme}',
    [ColorSchemeController::class, 'switch']
...
Route::group(['middleware' => ['web']], function () {
    ...
    Route::controller(PageController::class)->group(function () {
        ...
        Route::get('aproducts', [AstroMallController::class, 'getProduct'])->name('aproducts');
        Route::post('aproducts', [AstroMallController::class, 'getProduct'])->name('aproducts');
        ...
        Route::get('callHistory', action: [CallHistoryReportController::class, 'getCallHistory'])->name('callHistory');
